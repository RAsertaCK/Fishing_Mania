...
class UI:
    ...
    def render(self, screen):
        ...
        if self.game.current_state_name == 'fishing' and \
           ...
           hasattr(self.game.fishing_system, 'current_hooked_fish') and \
           self.game.fishing_system.current_hooked_fish: 
            
            hooked_fish_data = self.game.fishing_system.current_hooked_fish
