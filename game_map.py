...
class GameMap:
    LOCATIONS = {
        "Coast": {
            ...
            "background_file": "Pantai.png", # PASTIKAN INI Pantai.png
            "depth_range": (50, 150),
        ...
        "Sea": {
            ...
            "background_file": "Lautan.png", # PASTIKAN INI Laut.png
            "depth_range": (100, 300),
            "music": "sea_theme.ogg"
        },
        "Ocean": {
            ...
            "background_file": "Samudra.png", # PASTIKAN INI Samudra.png
            "depth_range": (200, 500),
    ...
    def __init__(self, location_map_name, config_instance):
        ...
        # bg_filename akan mengambil nilai dari "background_file" di self.data,
        # yang kita sudah ubah di LOCATIONS.
        # Jika ada masalah, itu karena nama file di LOCATIONS tidak cocok dengan file fisik.
        bg_filename = self.data.get("background_file") # Hapus fallback ke f"bg_{self.name.lower()}"
        if not bg_filename: # Tambahkan fallback yang lebih aman jika background_file tidak ada
            print(f"    PERINGATAN: background_file tidak didefinisikan untuk lokasi {self.name}. Menggunakan default.")
            bg_filename = f"default_background_{self.name.lower()}.png" # Default jika tidak ada
